;;; guara-theme.el --- Guara (light), ported from the Neovim colorscheme. -*- lexical-binding: t; no-byte-compile: t; -*-
...
(guara-define-theme guara light "Guara (light), ported from the Neovim colorscheme.")
